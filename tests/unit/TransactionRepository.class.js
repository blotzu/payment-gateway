...
let imports = {
    ...
    'sinon' : require('sinon'),
    'TransactionRepository' : require(__commonPath + '/lib/TransactionRepository.class.js'),
};

describe('TransactionRepository', function() {
    ...
    let repo = new imports.TransactionRepository(db, tableName);
